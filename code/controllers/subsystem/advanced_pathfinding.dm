//More Pathfinding attempts for the AI
...
/datum/controller/subsystem/advanced_pathfinding/proc/benchmark(run_number)
	...
	message_admins("DM Pathfinding: [dm_iterations/run_number] iter/sec | Rust: [rust_iterations/run_number] iter/sec")
#endif
